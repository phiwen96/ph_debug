...
#define debug_class_print_called_from(_color, index, ...) out (index, string (_color) + class_name + green + "::" + white + string (__FUNCTION__) + "::" + _function_line, white + string ("called from ") + _called_from_function + "::"  + to_string(_called_from_line) __VA_OPT__ (,) __VA_ARGS__); cout << white;
#define debug_called_from_none string _called_from_function = ""; int _called_from_line = 0; int _function_line = 0;

#define d0 debug_called_from
#define d1 debug_class_print_called_from
